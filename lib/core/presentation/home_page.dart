...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
    ...
    return StreamBuilder<UserProfile?>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          drawer: _buildDrawer(context, name, initials),
          body: SafeArea(
  ...
  Widget _buildHeroHeader(String firstName, String initials) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppColors.upcBlack.withValues(alpha: 0.25),
            blurRadius: 18,
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: AppColors.upcRed.withValues(alpha: 0.6),
                width: 2.5,
              ),
            ),
            child: CircleAvatar(
  ...
  Widget _buildStatsRow() {
    return FutureBuilder<List<Activity>>(
      ...
      builder: (context, snapshot) {
        ...
        final pendingTasks = activities
            .expand((a) => a.tasks)
            .where((t) => t.status == 'Pendiente')
            .length;
        final upcoming = activities.where((a) {
          final diff = a.dueDate.difference(DateTime.now()).inDays;
        ...
        return Row(
          children: [
            _buildStatCard(
              ...
              label: 'Actividades',
              value: isLoading ? '·' : '$totalActivities',
              color: AppColors.upcRed,
            ),
  ...
  Widget _buildDrawer(BuildContext context, String name, String initials) {
    return Drawer(
              ...
              children: [
                ...
                Icon(
                  ...
                  color: isDestructive
                      ...
                      : AppColors.upcGray.withValues(alpha: 0.3),
                  size: 14,
                ),
              ],
            ),
