...
class _MemberTaskPageState extends State<MemberTaskPage> {
  ...
  void initState() {
    ...
    _statusOptions = ['Pendiente', 'En Progreso', 'Entregado'];
    if (_isLeader || widget.task.status == 'Verificado') {
      _statusOptions.add('Verificado');
    }
    _status = widget.task.status;
    if (!_statusOptions.contains(_status)) _status = 'Pendiente';
      ...
      builder: (ctx) => Dialog(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('${widget.task.name} Actualizada\ncorrectamente', textAlign: TextAlign.center, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
  ...
  Widget build(BuildContext context) {
    final isReadOnly = !_isLeader && _status == 'Verificado';
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                              ...
                              onChanged: isReadOnly ? null : (v) { if (v != null) setState(() => _status = v); },
                            ),
                          ),
                        ),
                        ...
                        if (isReadOnly)
                          ...
                          Center(
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFE51D2A), foregroundColor: Colors.white, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)), padding: const EdgeInsets.symmetric(horizontal: 32, vertical: 12), elevation: 0),
