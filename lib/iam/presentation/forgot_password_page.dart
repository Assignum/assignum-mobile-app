  ...
  InputDecoration _customDecoration(String label) {
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(20),
        borderSide: const BorderSide(color: AppColors.upcRed, width: 1.5),
      ),
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: PageView(
          ...
          physics: const NeverScrollableScrollPhysics(), // transitions driven solely by the buttons
          onPageChanged: (page) {
            setState(() {
              _currentStep = page;
            });
      ...
      children: List.generate(2, (index) {
        ...
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isActive ? AppColors.upcRed : Colors.grey[300],
            ...
            CardContainer(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 32),
                  PrimaryButton(
                    text: _loading ? 'Enviando...' : 'Siguiente',
          ...
          CardContainer(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text(
                  'Por favor, revisa tu bandeja de entrada (y la carpeta de spam) y sigue las instrucciones en el enlace para restablecer tu contraseña de forma segura.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 14,
...
class _PulsingEmailIconState extends State<PulsingEmailIcon>
  ...
  Widget build(BuildContext context) {
    return ScaleTransition(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.upcRed.withOpacity(0.08),
